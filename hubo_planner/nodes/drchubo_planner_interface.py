...
class HuboPlannerInterface:
    ...
    def __init__(self, path):
        ...
        self.RequestHandler = rospy.Service("drchubo_planner/PlanningQuery", PlanTurning, self.PlanRequestHandler)
    ...
    def PlanRequestHandler(self, req):
        ...
        outMsg = PlanTurningResponse()
        outMsg.Response.header = Header()
        outMsg.Response.ErrorCode = error_str
        outMsg.Response.Labels = "LABELS"
        return outMsg
