...
class DrcHuboWheelTurning( BaseWheelTurning ):
    ...
    def BothHandsCW(self,radius, valveType):
    ...
    def LeftHandCW(self,radius,valveType):
        self.robotid.SetActiveManipulator('leftArm')
    ...
    def RightHandCW(self,radius,valveType):
        self.robotid.SetActiveManipulator('rightArm')
    ...
    def Run(self,handles=[],radius=None,manipulator=None,valveType=None):
        ...
        if(manipulator=="lh"):
            self.LeftHandCW(radius,valveType)
        elif(manipulator=="rh"):
            self.RightHandCW(radius,valveType)
        elif(manipulator=="bh"):
            self.BothHandsCW(radius,valveType)
...
if __name__ == "__main__":
    ...
    if demo:
        ...
        if play:
            ...
            # planner.Run(handles,0.1,manipulator="lh",valveType="l")
            ####################################################################################
            ...
            planner.SetWheelPoseFromTransform(MakeTransform(dot(rodrigues([0,0,pi/2]),rodrigues([pi/2-planner.tiltDiff+planner.worldPitch,0,0])),transpose(matrix([planner.wheelDistFromTSY+0.05, wheelY, planner.wheelHeight]))))
            planner.Run(handles,0.02,manipulator="lh",valveType="w")
            ####################################################################################
