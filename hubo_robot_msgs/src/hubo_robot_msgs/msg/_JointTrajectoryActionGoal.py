"""autogenerated by genpy from hubo_robot_msgs/JointTrajectoryActionGoal.msg. Do not edit."""
import sys
...
class JointTrajectoryActionGoal(genpy.Message):
  ...
  _type = "hubo_robot_msgs/JointTrajectoryActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','hubo_robot_msgs/JointTrajectoryGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = hubo_robot_msgs.msg.JointTrajectoryGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = hubo_robot_msgs.msg.JointTrajectoryGoal()
