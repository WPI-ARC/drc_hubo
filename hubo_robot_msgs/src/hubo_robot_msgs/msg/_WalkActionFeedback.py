"""autogenerated by genpy from hubo_robot_msgs/WalkActionFeedback.msg. Do not edit."""
import sys
...
class WalkActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "hubo_robot_msgs/WalkActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hubo_robot_msgs/WalkFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WalkActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hubo_robot_msgs.msg.WalkFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hubo_robot_msgs.msg.WalkFeedback()
