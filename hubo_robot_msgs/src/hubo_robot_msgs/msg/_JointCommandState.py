"""autogenerated by genpy from hubo_robot_msgs/JointCommandState.msg. Do not edit."""
import sys
...
class JointCommandState(genpy.Message):
  _md5sum = "575a9a87c4ab37d4b2ff877fdef03206"
  _type = "hubo_robot_msgs/JointCommandState"
...
"""
  __slots__ = ['header','joint_names','state']
  _slot_types = ['std_msgs/Header','string[]','hubo_robot_msgs/JointControllerState[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointCommandState, self).__init__(*args, **kwds)
