"""autogenerated by genpy from hubo_robot_msgs/JointCommandActionFeedback.msg. Do not edit."""
import sys
...
class JointCommandActionFeedback(genpy.Message):
  _md5sum = "6748c93936ec09bea082451ba1dcb0bb"
  _type = "hubo_robot_msgs/JointCommandActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hubo_robot_msgs/JointCommandFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointCommandActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hubo_robot_msgs.msg.JointCommandFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hubo_robot_msgs.msg.JointCommandFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.feedback.state.state)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.state.state:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.feedback.state.state.append(val1)
      return self
