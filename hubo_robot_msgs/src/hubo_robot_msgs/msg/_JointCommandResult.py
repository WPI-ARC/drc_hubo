"""autogenerated by genpy from hubo_robot_msgs/JointCommandResult.msg. Do not edit."""
import sys
...
class JointCommandResult(genpy.Message):
  _md5sum = "5f6dea5c123fbe1642c48555ade9d48c"
  _type = "hubo_robot_msgs/JointCommandResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointCommandResult, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.end_state is None:
        self.end_state = hubo_robot_msgs.msg.JointCommandState()
    else:
      self.end_state = hubo_robot_msgs.msg.JointCommandState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.end_state.state)
      buff.write(_struct_I.pack(length))
      for val1 in self.end_state.state:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.end_state.state.append(val1)
      return self
