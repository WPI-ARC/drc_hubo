"""autogenerated by genpy from hubo_robot_msgs/WalkActionResult.msg. Do not edit."""
import sys
...
class WalkActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hubo_robot_msgs/WalkActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hubo_robot_msgs/WalkResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WalkActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hubo_robot_msgs.msg.WalkResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hubo_robot_msgs.msg.WalkResult()
