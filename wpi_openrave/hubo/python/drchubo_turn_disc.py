...
def run(discRadius):
    ...
    T0_LH1 = dot(temp, MakeTransform(rodrigues([0,0,0]),transpose(matrix([0,0,discRadius+0.005]))))
    ...
    T0_RH1 = dot(temp, MakeTransform(rodrigues([0,0,0]),transpose(matrix([0,0,discRadius+0.005]))))
